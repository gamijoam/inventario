...
export const HELP_CONTENT = {
  ...
  purchases: {
    title: 'Compras - Recepcion, costos e IMEI',
    icon: 'CP',
    description: 'Registra mercancia recibida, actualiza inventario una sola vez, controla costos reales y crea cuentas por pagar cuando corresponde.',
    steps: [
      { title: '1. Elegir proveedor real', desc: 'Toda compra debe tener proveedor correcto. Asi la deuda, pagos, reclamos e historial quedan en una sola ficha.' },
      { title: '2. Buscar producto antes de crear', desc: 'Busca por nombre, SKU o codigo. Crear duplicados divide stock, Kardex, compras y precios.' },
      { title: '3. Crear producto con tipo correcto', desc: 'Si es nuevo, define si es producto normal, servicio, combo o serial/IMEI. Para telefonos, activa Serial/IMEI antes de recibir.' },
      { title: '4. Revisar cantidad y costo', desc: 'La cantidad sube stock. El costo alimenta ganancia real, Kardex y reportes. Costo cero debe quedar justificado.' },
      { title: '5. Capturar IMEI dentro de la compra', desc: 'Para equipos serializados, escanea o pega IMEIs en la misma recepcion. No los cargues luego desde Seriales porque puedes duplicar stock.' },
      { title: '6. Validar cantidad vs seriales', desc: 'Cantidad 5 exige 5 IMEIs validos. El sistema debe bloquear duplicados, vacios o seriales existentes.' },
      { title: '7. Definir contado o credito', desc: 'Contado no crea deuda. Credito crea cuenta por pagar con vencimiento, referencia y saldo pendiente.' },
      { title: '8. Confirmar y auditar', desc: 'Al procesar sube stock, registra Kardex, guarda seriales y actualiza proveedor. Revisa detalle si total, costo o saldo no cuadran.' },
    ],
    tips: [
      'Compra con IMEI incompleta no debe procesarse.',
      'Producto creado como normal no pedira seriales; corrige el tipo antes de recibir telefonos.',
      'Costo cero distorsiona ganancia real del dashboard y reportes.',
      ...
      'No uses ajustes manuales para tapar una compra mal cargada; corrige la compra si el flujo lo permite.',
    ],
    actions: ['Nueva compra', 'Seleccionar proveedor', 'Crear producto', 'Capturar IMEI', 'Validar costos', 'Marcar contado/credito', 'Registrar pago', 'Ver detalle'],
  },

  suppliers: {
    title: 'Proveedores - Contactos, deuda y pagos',
    icon: 'PV',
    description: 'Directorio de proveedores con condiciones de credito, deuda actual, compras, pagos e historial para cuentas por pagar.',
    steps: [
      { title: '1. Buscar antes de crear', desc: 'Busca por nombre, RIF, telefono o contacto. Un proveedor duplicado divide deuda y confunde reportes.' },
      { title: '2. Completar ficha', desc: 'Registra nombre comercial, contacto, telefono, correo, direccion y notas utiles para reposiciones o reclamos.' },
      { title: '3. Definir condiciones', desc: 'Configura dias de credito, limite y condiciones acordadas. Esto ayuda a planificar pagos y vencimientos.' },
      { title: '4. Leer deuda actual', desc: 'La deuda sale de compras a credito menos pagos registrados. Si no cuadra, revisa compras pendientes, pagos y duplicados.' },
      { title: '5. Registrar pagos con referencia', desc: 'Aplica cada abono al proveedor/compra correcta. Pagos sin referencia complican conciliacion.' },
      { title: '6. Usar historial', desc: 'Revisa compras, precios, pagos y saldos para negociar, reclamar o detectar facturas duplicadas.' },
    ],
    tips: [
      'No elimines proveedores con historial; edita datos o desactiva si existe esa opcion.',
      'Si la deuda sale alta, busca compras parciales, pendientes y pagos no registrados.',
      'Pago que no baja saldo suele estar aplicado al proveedor o compra incorrecta.',
      'Guarda numero de factura del proveedor en cada compra.',
      'Mantener WhatsApp/contacto actualizado acelera reposiciones.',
    ],
    actions: ['Nuevo proveedor', 'Buscar proveedor', 'Editar datos', 'Revisar deuda', 'Registrar pago', 'Ver historial', 'Reporte CxP'],
  },
