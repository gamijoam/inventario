...
export const HELP_CONTENT = {
  ...
  cash: {
    ...
    icon: 'CJ',
    description: 'Control operativo del dinero por turno. La caja abierta permite vender; el cierre compara lo que el sistema espera contra lo que se conto fisicamente.',
    steps: [
      { title: '1. Abrir caja antes de vender', desc: 'Al entrar al POS, selecciona una caja libre e ingresa el fondo inicial por moneda. Ese fondo es el efectivo real disponible para dar vuelto.' },
      { title: '2. Vender con caja activa', desc: 'Cada venta registra pagos por metodo. Efectivo afecta el arqueo fisico; pagos digitales se verifican por referencia y reporte.' },
      { title: '3. Registrar movimientos', desc: 'Usa Movimiento de Caja para entradas o salidas que no son ventas: compra de insumos, reposicion de fondo, retiro autorizado o ingreso externo.' },
      { title: '4. Registrar avances', desc: 'Avance es una transaccion dual: sale efectivo de caja y entra dinero por banco con comision. Debe tener referencia bancaria.' },
      { title: '5. Cerrar turno', desc: 'Al final del turno, cuenta fisicamente cada moneda e ingresa el monto contado. El sistema compara contra el esperado.' },
      { title: '6. Interpretar diferencia', desc: 'Cero significa cuadre correcto. Sobrante indica efectivo extra o ingreso no registrado. Faltante indica egreso no registrado, error de vuelto o dinero faltante.' },
      { title: '7. Investigar antes de acusar', desc: 'Revisa pagos mixtos, devoluciones, creditos, egresos, avances y ventas anuladas del mismo turno antes de concluir que hubo perdida.' },
      { title: '8. Usar reporte de caja', desc: 'Para auditoria, cruza cierre de turno con Reportes > Caja y Reportes > Ventas usando el mismo rango horario.' },
    ],
    tips: [
      'No vendas con una caja que no corresponde a tu estacion o cajero.',
      'Registra todo retiro en el momento; hacerlo al cierre suele causar descuadres.',
      'Pagos digitales no siempre significan efectivo fisico. No los cuentes como billetes.',
      'Si el cierre sale con diferencia, escribe observacion antes de confirmar.',
      'Cierra cada turno aunque haya pocas ventas para delimitar responsabilidades.',
    ],
    actions: ['Abrir caja', 'Seleccionar caja libre', 'Registrar movimiento', 'Registrar avance', 'Cerrar turno', 'Contar efectivo', 'Revisar reporte de caja'],
  },
