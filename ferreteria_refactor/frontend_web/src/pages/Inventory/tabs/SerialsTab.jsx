...
const SerialsTab = () => {
    ...
    const addImei = async () => {
        ...
        if (scannedList.includes(code)) {
            toast.error('Este IMEI ya esta en la lista de ingreso actual');
            setImeiInput('');
            return;
        }
        ...
        try {
            ...
            toast.error("Error de conexion validando IMEI");
            return; // Fail safe
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success(`Exito! Stock actualizado: ${res.data.new_stock_level} unidades.`);
    ...
    return (
        <div className="flex flex-col overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <p className="text-sm text-slate-500">Ingreso rapido de equipos por IMEI ("Metralleta")</p>
                </div>
            </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-2 space-y-2 custom-scrollbar max-h-[calc(100vh-300px)]">
                        ...
                        {scannedList.length === 0 && (
                            <div className="h-full flex flex-col items-center justify-center text-slate-300 py-12">
                                ...
                                <p className="text-sm">Lista vacia</p>
                            </div>
                        )}
                    </div>
