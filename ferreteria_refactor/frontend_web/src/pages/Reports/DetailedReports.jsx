...
import { BarChart, Wallet, Calendar, Users, ArrowUpRight, Download, FileText, Search } from 'lucide-react';
...
const DetailedReports = () => {
    ...
    const handleExport = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute('download', `Reporte_${activeTab}_${dateRange.start}.xlsx`);
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 flex-shrink-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2.5 rounded-xl hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200 font-bold text-sm active:scale-95"
                    >
                        <Download size={18} />
                        <span>Exportar</span>
                    </button>
