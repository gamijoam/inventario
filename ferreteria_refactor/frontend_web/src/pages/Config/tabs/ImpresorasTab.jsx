                                                ...
                                                <div className={clsx(
                                                    ...
                                                    <div style={{ whiteSpace: 'pre-wrap' }}>
                                                        {preset.template
                                                            ...
                                                            .replace(/{{ if sale.is_credit }}.*?{{ end }}/gs, "")
                                                            .replace(/<center>/g, " ".repeat(preset.paper_width === 80 ? 15 : 6))
                                                            .replace(/<\/center>/g, "")
                                                            .replace(/<right>/g, " ".repeat(preset.paper_width === 80 ? 25 : 10))
                                                            .replace(/<\/right>/g, "")
                                                            .replace(/<bold>/g, "")
                                                            .replace(/<\/bold>/g, "")
                                                            .replace(/<cut>/g, "")
