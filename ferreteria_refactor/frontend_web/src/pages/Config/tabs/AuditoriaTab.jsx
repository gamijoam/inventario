...
import { ClipboardList, Filter, RefreshCw, Clock, Database, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-between items-center flex-shrink-0">
                <div>
                    <p className="text-slate-500 font-medium">Log de cambios y seguridad</p>
                </div>
                <button
                    onClick={fetchLogs}
            ...
            {/* Filters */}
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 flex gap-4 items-center flex-shrink-0">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                <div className="overflow-y-auto flex-1 custom-scrollbar max-h-[60vh]">
