...
const DevolucionesTab = () => {
    ...
    return (
        <>
        <div className="flex flex-col bg-slate-50 p-6 overflow-hidden flex-1">
            {/* Header */}
                    ...
                    <>
                        ...
                        {resolutionType === 'EXCHANGE' && (
                            <div className="w-[420px] flex flex-col gap-4">
                                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 flex flex-col gap-3 max-h-full overflow-hidden">
