...
const POSConfig = () => {
    ...
    const getMagicLink = () => {
        ...
        // Remove quotes if they exist (common issue with some JSON storages)
        ...
        // 2. Handle Protocol Switch (http -> ws, https -> wss)
        ...
        // 3. Fix Localhost resolution for Windows (Force 127.0.0.1)
        ...
        // 4. Encode Parameters (Crucial for passing special chars in URIs)
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-300">
            ...
            {/* SECTION 2: HARDWARE BRIDGE - MANUAL CONFIGURATION GUIDE */}
            <Card>
                <CardHeader>
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex gap-2">
                                    <code className="flex-1 bg-white border border-slate-200 p-2 rounded text-sm font-mono text-slate-700">
                                        {(() => {
                                            // Dynamic Logic: http->ws, https->wss
                                            ...
                                            // Handle localhost edge case for display cleanliness
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        <code className="flex-1 bg-white border border-slate-200 p-2 rounded text-sm font-mono text-slate-700">
                                            {(() => {
                                                // Priority 0: Authenticated User Tenant (The Truth)
                                                ...
                                                // 2. Check LocalStorage (Dev/Mobile)
                                                if (!tenantId) {
