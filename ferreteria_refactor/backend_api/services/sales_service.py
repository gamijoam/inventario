...
{{ end }}"""
        ...
        # cliente NO tiene un template personalizado configurado.
        # Si el usuario seleccionó una plantilla en /ticket-templates/apply, esa
        # plantilla GANA siempre (respeta su elección incluso con celulares/IMEI).
