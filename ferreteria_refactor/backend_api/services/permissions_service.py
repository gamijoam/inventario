...
PERMISSION_SEEDS: Sequence[PermissionSeed] = (
    ...
    PermissionSeed("layaways.view", "sales", "Ver apartados"),
    PermissionSeed("layaways.create", "sales", "Crear apartados", "sensitive"),
    PermissionSeed("layaways.payments.add", "sales", "Registrar abonos de apartado", "sensitive"),
    PermissionSeed("layaways.complete", "sales", "Completar apartados", "critical"),
    PermissionSeed("layaways.cancel", "sales", "Cancelar apartados", "critical"),
    PermissionSeed("layaways.extend", "sales", "Prorrogar apartados", "sensitive"),
    PermissionSeed("layaways.release", "sales", "Liberar productos apartados", "critical"),
    PermissionSeed("layaways.refund", "sales", "Devolver abonos de apartado", "critical"),
    ...
    PermissionSeed("layaways.reports.view", "reports", "Ver reportes de apartados", "sensitive"),
    PermissionSeed("accounting.ledger.view", "accounting", "Ver libro contable", "critical"),
    PermissionSeed("accounting.ledger.export", "accounting", "Exportar libro contable", "critical"),
    PermissionSeed("accounting.ledger.rebuild", "accounting", "Reconstruir libro contable", "critical"),
    ...
    PermissionSeed("layaways.settings.manage", "config", "Configurar apartados", "critical"),
