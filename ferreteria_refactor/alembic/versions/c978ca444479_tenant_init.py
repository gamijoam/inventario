...
Revision ID: c978ca444479
Revises: 
Create Date: 2026-02-09 17:35:47.542778
...
def upgrade() -> None:
    ...
    sa.Column('initial_cash', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('initial_cash_bs', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('final_cash_reported', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('final_cash_reported_bs', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('final_cash_expected', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('final_cash_expected_bs', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('difference', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('difference_bs', sa.Numeric(precision=18, scale=4), nullable=True),
    ...
    sa.Column('price_mayor_1', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('price_mayor_2', sa.Numeric(precision=18, scale=4), nullable=True),
    ...
    sa.Column('warranty_notes', sa.String(), nullable=True),
    ...
    sa.Column('has_imei', sa.Boolean(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['usuario_id'], ['public.users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('total_amount_bs', sa.Numeric(precision=18, scale=4), nullable=True),
    ...
    sa.Column('due_date', sa.DateTime(), nullable=True),
    sa.Column('balance_pending', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('unique_uuid', sa.String(length=36), nullable=True),
    sa.Column('sync_status', sa.String(length=20), nullable=True),
    ...
    sa.Column('service_type', sa.Enum('REPAIR', 'LAUNDRY', name='servicetype'), nullable=True),
    sa.Column('priority', sa.Enum('NORMAL', 'HIGH', 'URGENT', name='servicepriority'), nullable=True),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('incoming_amount', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('incoming_currency', sa.String(), nullable=True),
    sa.Column('incoming_method', sa.String(), nullable=True),
    sa.Column('incoming_reference', sa.String(), nullable=True),
    sa.Column('date', sa.DateTime(), nullable=True),
    ...
    sa.Column('date', sa.DateTime(), nullable=True),
    sa.Column('movement_type', sa.Enum('PURCHASE', 'SALE', 'ADJUSTMENT', 'RETURN', 'ADJUSTMENT_IN', 'ADJUSTMENT_OUT', 'EXTERNAL_TRANSFER_IN', 'EXTERNAL_TRANSFER_OUT', name='movementtype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['waiter_id'], ['public.users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('tax_rate', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('cost_at_sale', sa.Numeric(precision=18, scale=4), nullable=True),
    sa.Column('subtotal', sa.Numeric(precision=18, scale=4), nullable=False),
    sa.Column('is_box_sale', sa.Boolean(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('unit_id', sa.Integer(), nullable=True),
    sa.Column('salesperson_id', sa.Integer(), nullable=True),
    sa.Column('warranty_expiration_date', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    sa.ForeignKeyConstraint(['sale_id'], ['sales.id'], ),
    sa.ForeignKeyConstraint(['salesperson_id'], ['public.users.id'], ),
    sa.ForeignKeyConstraint(['unit_id'], ['product_units.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('sale_detail_id', sa.Integer(), nullable=True),
    sa.Column('source_type', sa.String(), nullable=True),
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.Column('source_reference', sa.String(), nullable=True),
    sa.Column('amount', sa.Numeric(precision=12, scale=2), nullable=False),
    sa.Column('currency', sa.String(), nullable=True),
    sa.Column('percentage_applied', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'PAID', 'CANCELLED', 'VOIDED', name='commissionstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
